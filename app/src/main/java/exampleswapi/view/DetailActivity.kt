...
import exampleswapi.adapters.RelatedAdapter
import exampleswapi.bundle.DetailExtras
...
import exampleswapi.view.detail.description.*
import exampleswapi.view.detail.hero.HeroLayout
import exampleswapi.view.detail.hero.SquareHeroLayout
import exampleswapi.view.detail.hero.TallHeroLayout
import exampleswapi.view.detail.hero.WideHeroLayout
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (DetailExtras.hasAll(intent, DetailExtras.MODEL)) {
            intent.getSerializableExtra(DetailExtras.MODEL)?.let { viewModel.setModel(it) }
