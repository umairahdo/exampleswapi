...
import exampleswapi.adapters.SearchAdapter
import exampleswapi.bundle.DetailExtras
import exampleswapi.bundle.SearchExtras
import exampleswapi.listeners.RecyclerTouchListener
...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (SearchExtras.hasAll(intent, SearchExtras.CATEGORY, SearchExtras.QUERY)) {
            ...
            intent.getStringExtra(SearchExtras.QUERY)?.let {
                viewModel.setQueryAndCategory(it,
